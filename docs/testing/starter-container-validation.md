...
- **Codex CLI 0.155.0-alpha.2.6:** installation and app-server discovery found exactly **22 enabled JARVIS skills** and **two enabled hooks marked untrusted**. Trust was not granted. Discovery does not prove hook execution. This alpha version is distinct from the historical stable 0.154.0 container check below.
