...
- **Architecture and design work**: when a system-design pass (e.g. the `architect` agent) proposes architecture changes, suggest creating an ADR
- **Code review**: flag pull requests that introduce architectural changes without a corresponding ADR
