...
This is a general-purpose migration discipline skill. On any D1/SQL app in this workspace, it applies alongside — not instead of — the workspace's own additive-migrations rule: additive changes only, never destructive schema edits without an explicit, separately-approved plan.
