...
- Skills: [frontend-patterns](../frontend-patterns/SKILL.md) for broader React/Next.js component patterns
- For applying and implementing fixes flagged by this skill's rules, use the jarvis-cc `executor` agent; for build failures, `build-error-resolver`; for deeper architectural calls, `architect`
