---
name: search-first
description: Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Invokes an explorer/research subagent.
---
...
For non-trivial functionality, launch a research-focused subagent — jarvis-cc's
explorer agent is a good fit for this (search, read, list, find, reconnaissance),
or a general-purpose subagent if explorer is unavailable:
...
Whatever plans the implementation — a planner-style agent, the `writing-plans`
skill, or manual planning — should invoke this search-first workflow before
committing to an approach:
- Research identifies available tools first
- The plan incorporates them into the implementation, instead of assuming custom code
- Avoids "reinventing the wheel" in the plan

### With architect agent
jarvis-cc's architect agent should consult this workflow for:
