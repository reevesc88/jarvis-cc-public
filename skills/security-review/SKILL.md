...
#### FAIL: NEVER Do This
Do not place API keys or database passwords directly in source code, even as example assignments. Keep credentials outside the repository and read them from the environment.
